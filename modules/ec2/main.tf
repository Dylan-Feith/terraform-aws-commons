...
resource "aws_instance" "this" {
  ...
  # start edit #
  iam_instance_profile = try(aws_iam_instance_profile.this[0].name, "")
  # end edit #
  ...
  dynamic "root_block_device" {
    ...
    content {
      ...
      kms_key_id = lookup(root_block_device.value, "encrypted", true) ? lookup(root_block_device.value, "kms_key_id", data.aws_kms_key.ebs.arn) : null
      # end edit #
  ...
  dynamic "ebs_block_device" {
    ...
    content {
      ...
      kms_key_id = lookup(ebs_block_device.value, "encrypted", true) ? lookup(ebs_block_device.value, "kms_key_id", data.aws_kms_key.ebs.arn) : null
      # end edit #
