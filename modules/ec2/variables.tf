...
variable "associate_public_ip_address" {
  ...
  type        = bool
  # start edit #
  # We want false by default
  # Be carefull, conflits with: network_interface
  # You must set it to null when network_interface is specified
  # default     = null
  default = false
  # end edit #
}
...
variable "root_block_device" {
  ...
  type        = list(any)
  # start edit #
  # default must not be empty, otherwise for_each do not apply and encryption is not forced
  default = [{
    encrypted = true
    }
  ]
