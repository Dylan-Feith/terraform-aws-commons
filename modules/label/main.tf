locals {
  ...
  defaults = {
    ...
    # start edit #
    label_order = ["customer", "project", "environment", "tfrun", "attributes"]
    # end edit #
  ...
  input = {
    ...
    globalenv   = var.globalenv == null ? var.context.globalenv : var.globalenv
    name        = var.name == null ? var.context.name : var.name
    project     = var.project == null ? var.context.project : var.project
    tfrun       = var.tfrun == null ? var.context.tfrun : var.tfrun
  ...
  string_label_names = ["customer", "project", "environment", "globalenv", "name", "tfrun", "type"]
  ...
  customer    = local.formatted_labels["customer"]
  environment = local.formatted_labels["environment"]
  globalenv   = local.formatted_labels["globalenv"]
  name        = local.formatted_labels["name"]
  project     = local.formatted_labels["project"]
  tfrun       = local.formatted_labels["tfrun"]
  type        = local.formatted_labels["type"]
  ...
  generated_tags = {
    ...
    local.label_key_case == "upper" ? upper(l) : (
      # start edit
      local.label_key_case == "lower" ? (l != "name" ? lower(l) : title(lower(l))) : title(lower(l))
      # end edit
