resource "aws_lb" "this" {
  # start edit feature 1 #
  count = var.create_lb && var.lb_arn == "" ? 1 : 0
  # end edit feature 1 #
...
resource "aws_lb_listener_rule" "https_listener_rule" {
  ...
  # start edit feature 2 #
  listener_arn = try(var.https_listener_rules[count.index].listener_arn, aws_lb_listener.frontend_https[lookup(var.https_listener_rules[count.index], "https_listener_index", count.index)].arn)
  # end edit feature 2 #
  ...
  dynamic "action" {
    ...
    content {
      type = action.value["type"]
      # start edit feature 3 #
      target_group_arn = try(action.value.target_group_arn, aws_lb_target_group.main[lookup(action.value, "target_group_index", count.index)].id)
      # end edit feature 3 #
    }
  }
...
resource "aws_lb_listener_rule" "http_tcp_listener_rule" {
  ...
  # start edit feature 2 #
  listener_arn = try(var.http_tcp_listener_rules[count.index].listener_arn, aws_lb_listener.frontend_http_tcp[lookup(var.http_tcp_listener_rules[count.index], "http_tcp_listener_index", count.index)].arn)
  # end edit feature 2 #
...
resource "aws_lb_listener" "frontend_http_tcp" {
  ...
  # start edit feature 1 #
  load_balancer_arn = var.lb_arn != "" ? var.lb_arn : aws_lb.this[0].arn
  # end edit feature 1 #
